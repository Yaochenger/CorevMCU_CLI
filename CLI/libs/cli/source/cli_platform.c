...
static rt_thread_t  CLI_task_thread = RT_NULL;
...
//    CLI_task_thread =                        		  	/* 线程控制块指针 */
//    rt_thread_create( "CLI",             	 /* 线程名字 */
//                      CLI_task,  		 /* 线程入口函数 */
//                      RT_NULL,            			 /* 线程入口函数参数 */
//                      14 * CLI_TASK_STACKSIZE,                 				/* 线程栈大小 */
//                      RT_THREAD_PRIORITY_MAX-2,                 				  /* 线程的优先级 */
//                      20);                 				/* 线程时间片 */
//    /* 启动线程，开启调度 */
//        rt_thread_startup(CLI_task_thread);
     ...
     xTaskCreate ( CLI_task,    //task
					...
					NULL, 		//paratmeter
					(UBaseType_t)(tskIDLE_PRIORITY+25), //priotity
					&xHandleTestCli);//TCB
